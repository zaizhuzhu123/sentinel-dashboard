 ...
 */
@Component
public class InMemParamFlowRuleStore extends InDatabaseRuleRepositoryAdapter<ParamFlowRuleEntity> {
    ...
    public void publishMachineRules(String app, String ip, int port) {
        List<ParamFlowRuleEntity> allRules = findAllByMachine(MachineInfo.of(app, ip, port));
        sentinelApiClient.setParamFlowRuleOfMachine(app, ip, port, allRules);
    }
