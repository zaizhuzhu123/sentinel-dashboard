 ...
 */
@Component
public class InMemApiDefinitionStore extends InDatabaseRuleRepositoryAdapter<ApiDefinitionEntity> {
    ...
    public void publishMachineRules(String app, String ip, int port) {
        List<ApiDefinitionEntity> allRules = findAllByMachine(MachineInfo.of(app, ip, port));
        sentinelApiClient.modifyApis(app, ip, port, allRules);
    }
